...
O **`svcprobe`** consolida todo o ciclo de diagnóstico de rede em uma ferramenta única, leve e extremamente veloz, capaz de identificar com precisão a causa raiz de falhas e gargalos de latência.
...
- **🔍 Diagnóstico Multi-Camada Concatenado (`check`)**: Auditoria automática de cabo a rabo (DNS → TCP → TLS → HTTP) em uma única execução.
...
<div align="center">
Desenvolvido por <a href="https://github.com/augusttw"><b>augusttw</b></a>
</div>
